...
export default function HambMenu() {
 const [isOpen, setOpen] = useState(false)
  ...
  return ( <>
  <div className="mr-[50px] fixed top-14 right-3 z-50 ">
  ...
  { isOpen ?(
    <div className="flex flex-col justify-between gap-3 rounded-lg shadow-md p-5 absolute w-[100px] right-[50px] mt-4 items-center bg-slate-400 md:hidden">
